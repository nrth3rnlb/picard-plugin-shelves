...
#         self.vote_for_shelf(
#             album_id, shelf, weight=float("inf"), reason="manual override"
#         )
#
#     return shelf
...
#             log.warning(
#                 "%s: Shelf for album %s could not be determined with certainty.",
#                 PLUGIN_NAME,
#                 album_id,
#             )
...
# Wrapper
def vote_for_shelf(
    album_id: str, shelf: str, weight: float = 1.0, reason: str = ""
) -> None:
