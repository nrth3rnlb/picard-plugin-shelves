...
class ProcessorPriorityTest(unittest.TestCase):
    ...
    def test_physical_location_overrides_manual_tag(self, mock_config, mock_get_shelves,
        ...
        with patch('shelves.processors.ShelfUtils.get_shelf_from_path', return_value=("Soundtracks", True)):
            # Act
        ...
        mock_manager.set_album_shelf.assert_called_with("album123", "Soundtracks", source="manual", lock=True)
    ...
    def test_manual_tag_overrides_workflow(self, mock_config, mock_get_configured_shelves, mock_add_shelf,
        ...
        with patch('shelves.processors.ShelfUtils.get_shelf_from_path', return_value=("Incoming", False)):
            # Act
            file_post_addition_to_track_processor(track=None, file=file)
