...
class WorkflowTest(unittest.TestCase):
    ...
    def test_empty_shelf_is_not_transitioned(self, mock_config):
        ...
        self.assertEqual(WorkflowEngine.apply_workflow_transition(""), "")
    ...
    def test_stage1_match_transitions(self, mock_config):
        ...
        mock_config.setting = self.config_setting
        self.assertEqual(
            WorkflowEngine.apply_workflow_transition("Standard"), "Standard"
        )
    ...
    def test_no_match_in_stage1_leaves_shelf(self, mock_config):
        ...
        mock_config.setting = self.config_setting
        self.assertEqual(
            WorkflowEngine.apply_workflow_transition("other_shelf"), "other_shelf"
        )
